...
babi_train_raw, babi_test_raw = utils.get_semeval_raw()
...
def do_epoch(mode, epoch, skipped=0):
    ...
    test_acc = accuracy * 100.0 / batches_per_epoch / args.batch_size
    print "accuracy: %.2f percent" % test_acc
    
    return avg_loss, skipped, test_acc
...
#            dmn.shuffle_train_set()
        ...
        _, skipped, _ = do_epoch('train', epoch, skipped)
